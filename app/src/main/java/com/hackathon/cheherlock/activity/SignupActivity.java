...
public class SignupActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _nameText = (EditText) this.findViewById(R.id.input_email);
        _passwordText = (EditText) this.findViewById(R.id.input_email);
        _signupButton = (Button) this.findViewById(R.id.btn_signup);
